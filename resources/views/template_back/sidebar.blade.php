...
<aside class="main-sidebar app-sidebar sidebar-scroll">
	<div class="main-sidebar-header">
		<a class="desktop-logo logo-light active" href="index.html" class="text-center mx-auto"><img src="{{ asset('') }}assets/img/brand/logo.png" class="main-logo"></a>
		<a class="desktop-logo icon-logo active"href="index.html"><img src="{{ asset('') }}assets/img/brand/favicon.png" class="logo-icon"></a>
	...
	<div class="main-sidebar-body">
		<ul class="side-menu ">
			...
			<li class="slide">
						<a class="side-menu__item" href="{{ route('dataproduksi.index') }}"><i class="side-menu__icon fe fe-award"></i><span class="side-menu__label">data produksi</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-map-pin menu-icon"></i><span class="side-menu__label">stok barang</span><span class="badge badge-pink side-badge">1</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-layout"></i><span class="side-menu__label">Hasil Pemasaran</span><span class="badge badge-pink side-badge">1</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
